  ...
  <div class="container">
    ...
    <div class="webInfo">
      <div class="info-container">
        <div class="beian">闽ICP备2021002460号(宇宏物流)</div>
        <div class="support">CopyRight &copy; 2021-2031 宁德神灯网络科技</div>
        ...
        <img class="code" src="../../assets/404_images/sd365Code.png" width="60" alt="" srcset="">
        <div class="support2">宁德神灯网络科技</div>
      </div>
    </div>
  </div>
